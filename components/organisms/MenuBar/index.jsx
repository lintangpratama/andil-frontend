...
export default function MenuBar(props) {
  ...
  return (
    <div className="flex bg-white fixed bottom-0 h-13 justify-around z-30 max-w-md w-full -ml-4 mr-10 border-gray-icon border-t-[1px]">
      <Menu role={role} currentPage={currentPage} />

      <Link href={role === "pengurus" ? "/pengurus/transaksi" : "/transaksi"} passHref={true}>
            ...
            <span className="inline-flex flex-col w-full justify-center items-center">
              ...
              >
                <path
                  ...
                  fill={
                    currentPage === "transaksi" ? "#FFDA44" : "#1F1F1F"
                  }
                  fillOpacity={currentPage === "transaksi" ? "1" : "0.5"}
                />
              </svg>
      ...
      <Link href="/pengurus/buat-tagihan" passHref={true}>
        <button className="px-3 py-2 w-1/5 max-w-bar  cursor-pointer -mt-0.5 relative bottom-5">
          <a>
            <span className="inline-flex flex-col w-full justify-center items-center">
      ...
      <Link href={role === "pengurus" ? "/pengurus/pesan" : "/pesan"} passHref={true}>
        <button className="px-3 py-2 w-1/5 max-w-bar  cursor-pointer -mt-0.5">
          <a>
            <span className="inline-flex flex-col w-full justify-center items-center">
              <svg
              ...
              >
                <path
                  ...
                  fill={currentPage === "pesan" ? "#FFDA44" : "#1F1F1F"}
                  fillOpacity={currentPage === "pesan" ? "1" : "0.5"}
                />
              </svg>
      ...
      <Link href={role === "pengurus" ? "/pengurus/profil" : "/profil"} passHref={true}>
        <button className="px-3 py-2 w-1/5 max-w-bar  cursor-pointer -mt-0.5">
          <a>
            <span className="inline-flex flex-col w-full justify-center items-center">
              <svg
              ...
              >
                <path
                  ...
                  fill={currentPage === "profil" ? "#FFDA44" : "#1F1F1F"}
                  fillOpacity={currentPage === "profil" ? "1" : "0.5"}
                />
              </svg>
